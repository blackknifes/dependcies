...
function (DownloadLibraryTarGZip name url internelName)
    file(GLOB CheckExists "${TEMP_PATH}/${internelName}.tar.gz")
    if(NOT CheckExists)
        message(STATUS "download ${internelName} from ${url} .......")
        file(DOWNLOAD ${url} "${TEMP_PATH}/${internelName}.tar.gz" INACTIVITY_TIMEOUT 5 TIMEOUT 30 TLS_VERIFY OFF SHOW_PROGRESS)
    endif()
    set(CheckExists)
